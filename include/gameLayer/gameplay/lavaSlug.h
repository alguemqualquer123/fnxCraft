...
struct LavaSlug: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct LavaSlugClient: public ClientEntity<LavaSlug, LavaSlugClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct LavaSlugServer: public ServerEntity<LavaSlug>
{
