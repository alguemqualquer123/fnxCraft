...
struct CrystalSentinel: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct CrystalSentinelClient: public ClientEntity<CrystalSentinel, CrystalSentinelClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct CrystalSentinelServer: public ServerEntity<CrystalSentinel>
{
