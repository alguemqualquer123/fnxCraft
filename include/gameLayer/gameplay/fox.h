...
struct Fox: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct FoxClient: public ClientEntity<Fox, FoxClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct FoxServer: public ServerEntity<Fox>
{
