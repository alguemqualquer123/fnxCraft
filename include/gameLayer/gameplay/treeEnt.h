...
struct TreeEnt: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct TreeEntClient: public ClientEntity<TreeEnt, TreeEntClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct TreeEntServer: public ServerEntity<TreeEnt>
{
