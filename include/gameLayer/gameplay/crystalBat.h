...
struct CrystalBat: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct CrystalBatClient: public ClientEntity<CrystalBat, CrystalBatClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct CrystalBatServer: public ServerEntity<CrystalBat>
{
