...
struct CapybaraChef: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct CapybaraChefClient: public ClientEntity<CapybaraChef, CapybaraChefClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct CapybaraChefServer: public ServerEntity<CapybaraChef>
{
