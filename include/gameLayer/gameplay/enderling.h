...
struct Enderling: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct EnderlingClient: public ClientEntity<Enderling, EnderlingClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct EnderlingServer: public ServerEntity<Enderling>
{
