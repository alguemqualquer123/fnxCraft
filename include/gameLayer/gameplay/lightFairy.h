...
struct LightFairy: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct LightFairyClient: public ClientEntity<LightFairy, LightFairyClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct LightFairyServer: public ServerEntity<LightFairy>
{
