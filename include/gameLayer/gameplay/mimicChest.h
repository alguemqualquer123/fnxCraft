...
struct MimicChest: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct MimicChestClient: public ClientEntity<MimicChest, MimicChestClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct MimicChestServer: public ServerEntity<MimicChest>
{
