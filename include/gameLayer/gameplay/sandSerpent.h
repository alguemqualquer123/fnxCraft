...
struct SandSerpent: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct SandSerpentClient: public ClientEntity<SandSerpent, SandSerpentClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct SandSerpentServer: public ServerEntity<SandSerpent>
{
