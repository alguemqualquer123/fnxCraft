...
struct Creeper: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct CreeperClient: public ClientEntity<Creeper, CreeperClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct CreeperServer: public ServerEntity<Creeper>
{
