...
struct SkeletonPirate: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct SkeletonPirateClient: public ClientEntity<SkeletonPirate, SkeletonPirateClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct SkeletonPirateServer: public ServerEntity<SkeletonPirate>
{
