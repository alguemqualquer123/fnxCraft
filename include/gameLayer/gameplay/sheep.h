...
struct Sheep: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct SheepClient: public ClientEntity<Sheep, SheepClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct SheepServer: public ServerEntity<Sheep>
{
