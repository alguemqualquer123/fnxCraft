...
struct HoneyBear: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct HoneyBearClient: public ClientEntity<HoneyBear, HoneyBearClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct HoneyBearServer: public ServerEntity<HoneyBear>
{
