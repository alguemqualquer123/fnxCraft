...
struct StoneGolem: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct StoneGolemClient: public ClientEntity<StoneGolem, StoneGolemClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct StoneGolemServer: public ServerEntity<StoneGolem>
{
