...
struct Wolf: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct WolfClient: public ClientEntity<Wolf, WolfClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct WolfServer: public ServerEntity<Wolf>
{
