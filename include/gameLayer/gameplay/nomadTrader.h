...
struct NomadTrader: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct NomadTraderClient: public ClientEntity<NomadTrader, NomadTraderClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct NomadTraderServer: public ServerEntity<NomadTrader>
{
