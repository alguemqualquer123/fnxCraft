...
struct CaveSpider: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct CaveSpiderClient: public ClientEntity<CaveSpider, CaveSpiderClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct CaveSpiderServer: public ServerEntity<CaveSpider>
{
