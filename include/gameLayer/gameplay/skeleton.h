...
struct Skeleton: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct SkeletonClient: public ClientEntity<Skeleton, SkeletonClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct SkeletonServer: public ServerEntity<Skeleton>
{
