...
struct Manatee: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct ManateeClient: public ClientEntity<Manatee, ManateeClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct ManateeServer: public ServerEntity<Manatee>
{
