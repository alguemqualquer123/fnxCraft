...
struct JuvenileDragon: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct JuvenileDragonClient: public ClientEntity<JuvenileDragon, JuvenileDragonClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct JuvenileDragonServer: public ServerEntity<JuvenileDragon>
{
