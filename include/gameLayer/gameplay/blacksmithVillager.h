...
struct BlacksmithVillager: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct BlacksmithVillagerClient: public ClientEntity<BlacksmithVillager, BlacksmithVillagerClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct BlacksmithVillagerServer: public ServerEntity<BlacksmithVillager>
{
