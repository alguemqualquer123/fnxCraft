...
struct HermitCrab: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct HermitCrabClient: public ClientEntity<HermitCrab, HermitCrabClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct HermitCrabServer: public ServerEntity<HermitCrab>
{
