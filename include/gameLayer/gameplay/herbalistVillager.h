...
struct HerbalistVillager: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct HerbalistVillagerClient: public ClientEntity<HerbalistVillager, HerbalistVillagerClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct HerbalistVillagerServer: public ServerEntity<HerbalistVillager>
{
