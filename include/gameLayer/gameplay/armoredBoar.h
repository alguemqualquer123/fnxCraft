...
struct ArmoredBoar: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct ArmoredBoarClient: public ClientEntity<ArmoredBoar, ArmoredBoarClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct ArmoredBoarServer: public ServerEntity<ArmoredBoar>
{
