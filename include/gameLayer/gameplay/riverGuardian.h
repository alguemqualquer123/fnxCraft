...
struct RiverGuardian: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct RiverGuardianClient: public ClientEntity<RiverGuardian, RiverGuardianClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct RiverGuardianServer: public ServerEntity<RiverGuardian>
{
