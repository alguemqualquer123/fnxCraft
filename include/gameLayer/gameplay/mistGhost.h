...
struct MistGhost: public PhysicalEntity, public HasOrientationAndHeadTurnDirection,
...
struct MistGhostClient: public ClientEntity<MistGhost, MistGhostClient>
{
	void update(float deltaTime, decltype(chunkGetterSignature) *chunkGetter);
	void setEntityMatrix(glm::mat4 *skinningMatrix);
	int getTextureIndex();
};
struct MistGhostServer: public ServerEntity<MistGhost>
{
